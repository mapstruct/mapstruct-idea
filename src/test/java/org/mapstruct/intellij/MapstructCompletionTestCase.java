...
public class MapstructCompletionTestCase extends MapstructBaseCompletionTestCase {
    ...
    private void assertCarDtoPublicAutoComplete() {
        ...
        assertThat( myItems )
            ...
            .usingRecursiveFieldByFieldElementComparator()
            .containsExactlyInAnyOrder(
                createField( "make", "String" ),
                createField( "seatCount", "int" ),
                createField( "manufacturingYear", "String" ),
                createField( "myDriver", "PersonDto" ),
                createField( "passengers", "List<PersonDto>" ),
                createField( "price", "Long" ),
                createField( "category", "String" ),
                createField( "available", "boolean" )
            );
    }
